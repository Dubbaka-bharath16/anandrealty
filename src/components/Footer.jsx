...
const Footer = () => {
  ...
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M18.9 2H22l-7.3 8.4L23 22h-6.6l-5.2-6.8L5.3 22H2l7.8-9L1 2h6.7l4.7 6.2L18.9 2z" />
  </svg>
),
  ...
  return (
    <>
      <footer className="light-navy text-white">
    ...
    />
                ...
                <div className="text-left">
                  <p className="text-gray-300 mb-2 text-xs md:text-sm leading-relaxed">
                    Transforming raw land into premium residential plots with expertise in ethical real estate development.
                  </p>
                  <p className="text-gray-300 mb-2 text-xs md:text-sm leading-relaxed">
                    Creating sustainable, Vastu-compliant plotted communities with complete legal transparency and long-term value.
                  </p>
                  <p className="text-gray-300 text-xs md:text-sm leading-relaxed">
                    Building generational legacies through meticulously planned developments that safeguard investments for the future.
                  </p>
                </div>
              </div>
              ...
              {/* Quick Links */}
              <div className="text-left">
                <h3 className="text-base md:text-lg font-semibold mb-3 text-orange-400">Quick Links</h3>
                <div className="space-y-1 md:space-y-2">
                  {quickLinks.map((link, index) => (
                    <Link
                      key={index}
                      to={link.path}
                      className="block text-gray-300 py-0.5 md:py-1 text-xs md:text-sm hover:text-orange-400 transition-all duration-200"
                    >
                      {link.label}
                    </Link>
                  ))}
                  ...
                  <button
                    ...
                    className="block text-gray-300 py-0.5 md:py-1 text-xs md:text-sm hover:text-orange-400 transition-all duration-200 w-full text-left"
                  >
              ...
              <div className="text-left">
                <h3 className="text-base md:text-lg font-semibold mb-3 text-orange-400">Contact</h3>
                <div className="space-y-2 md:space-y-3 text-xs md:text-sm">
                  <div className="flex flex-col items-start space-y-1 md:space-y-2">
                    <div className="flex items-start space-x-1 md:space-x-2">
                      <i className="fas fa-map-marker-alt text-orange-400 mt-0.5 text-xs md:text-sm" />
                      <span className="text-gray-300 text-left text-xs md:text-sm">
                    ...
                    <div className="flex items-center space-x-1 md:space-x-2">
                      <i className="fas fa-phone text-orange-400 text-xs md:text-sm" />
                      <span className="text-gray-300 text-xs md:text-sm">+91 1800 123 4857</span>
                    </div>
                  ...
                  <div className="pt-2">
                    <div className="flex space-x-2">
                      {[
                        ...
                        { name: "x", url: "#", color: "hover:bg-blue-400" },
                        ...
                        <a
                          ...
                          className={`w-8 h-8 md:w-10 md:h-10 bg-white/10 rounded-lg flex items-center justify-center text-white transition-all duration-300 hover:scale-110 ${social.color}`}
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                {["Privacy", "Terms", "Disclaimer", "RERA"].map((item) => (
                  <button
                    ...
                    className="text-gray-500 hover:text-orange-400 transition-colors text-xs md:text-sm font-medium hover:underline"
                  >
                    {item}
                  </button>
                ))}
