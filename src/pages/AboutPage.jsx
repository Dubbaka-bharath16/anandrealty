...
const About = () => {
  ...
  const values = [
    ...
    {
      icon: <i className="fas fa-balance-scale text-blue-600"></i>,
      title: "Vastu Science",
                ...
                <div className="w-full">
                  ...
                  <div className="mt-4 md:mt-6 text-gray-700 space-y-4 w-full">
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                      A visionary leader with an unwavering commitment to excellence, Anand ensures every
                      property rests on strong legal foundations through meticulous scrutiny and ethical practices.
                    </p>
                    <p className="text-sm sm:text-base md:text-lg leading-relaxed">
                      By blending modern design with traditional Vastu principles, he creates balanced,
                      future ready spaces offering accessible luxury without compromise. His vision is to enriching lifestyles,
                      safeguarding investments, and standing as lasting legacies for generations.
                    </p>
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-12 md:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-2 sm:px-4">
                Creating harmonious residential spaces where contemporary living and lasting value converge,
                building generational legacies through meticulously planned developments
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto px-2 sm:px-0">
            {values.map((value, index) => (
              ...
              >
                <div className="text-3xl sm:text-4xl md:text-5xl mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  {value.icon}
                </div>
